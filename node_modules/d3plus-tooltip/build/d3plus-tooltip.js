...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-selection'), require('d3plus-color'), require('d3plus-common'), require('@popperjs/core')) : typeof define === 'function' && define.amd ? define('d3plus-tooltip', ['exports', 'd3-selection', 'd3plus-color', 'd3plus-common', '@popperjs/core'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}, global.d3Selection, global.d3plusColor, global.d3plusCommon, global.core));
})(this, function (exports, d3Selection, d3plusColor, d3plusCommon, core) {
  'use strict';
    ...
    */
    _createClass(Tooltip, [{
      ...
      value: function render(callback) {
        var _this2 = this;
        var that = this;
        var tooltips = d3Selection.select(this._parent).selectAll(".".concat(this._className)).data(this._data, this._id);
        ...
        */
        ...
        enter.attr("id", function (d, i) {
          ...
          _this2._popperClasses[id] = core.createPopper(referenceObject, tooltip, {
            placement: "top",
