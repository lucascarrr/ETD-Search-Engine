    ...
    _createClass(Shape, [{
      ...
      */
      ...
      value: function render(callback) {
        ...
        this._transition = d3Transition.transition(this._uuid).duration(this._duration);
        var data = this._data,
          key = this._id;
        if (this._dataFilter) {
    ...
    _createClass(Area, [{
      ...
      */
      ...
      value: function render(callback) {
        ...
        var path = this._path = paths__namespace.area().defined(this._defined).curve(curve).x(this._x).x0(this._x0).x1(this._x1).y(this._y).y0(this._y0).y1(this._y1);
        var exitPath = paths__namespace.area().defined(function (d) {
          return d;
  ...
  var Line = /*#__PURE__*/function (_Shape5) {
    ...
    */
    function Line() {
      ...
      _this19._name = "Line";
      _this19._path = paths__namespace.line();
    ...
    _createClass(Whisker, [{
      ...
      value: function render(callback) {
        ...
        d3Collection.nest().key(function (d) {
          ...
          _this24._whiskerEndpoint.push(new shapes$1[shapeName]().data(shapeData.values).select(d3plusCommon.elem("g.d3plus-Whisker-Endpoint-".concat(shapeName), {
    ...
    _createClass(Box, [{
      ...
      value: function render() {
        ...
        this._box = new Rect().data(filteredData).x(function (d) {
          ...
          parent: this._select
        }).node()).config(d3plusCommon.configPrep.bind(this)(this._rectConfig, "shape")).render();
        ...
        this._median = new Rect().data(filteredData).x(function (d) {
          ...
          parent: this._select
        }).node()).config(d3plusCommon.configPrep.bind(this)(this._medianConfig, "shape")).render();
        ...
        this._whisker = new Whisker().data(whiskerData).select(d3plusCommon.elem("g.d3plus-Box-Whisker", {
          parent: this._select
        }).node()).config(d3plusCommon.configPrep.bind(this)(this._whiskerConfig, "shape")).render();
        ...
        d3Collection.nest().key(function (d) {
          ...
          var shapeName = shapeData.key;
          _this26._whiskerEndpoint.push(new shapes[shapeName]().data(shapeData.values).select(d3plusCommon.elem("g.d3plus-Box-Outlier-".concat(shapeName), {
