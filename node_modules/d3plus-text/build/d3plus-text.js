...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-selection'), require('d3-transition'), require('d3-array'), require('d3plus-common')) : typeof define === 'function' && define.amd ? define('d3plus-text', ['exports', 'd3-selection', 'd3-transition', 'd3-array', 'd3plus-common'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}, global.d3Selection, null, global.d3Array, global.d3plusCommon));
  ...
  */
  ...
  var elemRTL = function elemRTL(e) {
    return d3Selection.select(e).size() && (d3Selection.select(e).attr("dir") === "rtl" || d3Selection.select(e).style("direction") === "rtl");
  };
  ...
  */
  var detectRTL = function detectRTL() {
    ...
    elem = d3Selection.select(elem).node();
  ...
  */
  ...
  var splitChars = ["-", ";", ":", "&", "|", "u0E2F",
  // thai character pairannoi
  "u0EAF",
  // lao ellipsis
  "u0EC6",
  // lao ko la (word repetition)
  "u0ECC",
  ...
  // em dash
  "u2027",
  // simplified chinese hyphenation point
  "u3000",
  // simplified chinese ideographic space
  "u3001",
  // simplified chinese ideographic comma
  "u3002",
  // simplified chinese ideographic full stop
  "uFF0C",
  // full-width comma
  "uFF5E" // wave dash
  ];

  var prefixChars = ["'", "<", "(", "{", "[", "u00AB",
    ...
    */
    _createClass(TextBox, [{
      ...
      value: function render(callback) {
        ...
        var rtl = detectRTL(this._select.node());
