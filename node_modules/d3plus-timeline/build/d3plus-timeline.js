...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-array'), require('d3-brush'), require('d3-scale'), require('d3-selection'), require('d3plus-axis'), require('d3plus-color'), require('d3plus-common'), require('d3plus-format'), require('d3plus-text')) : typeof define === 'function' && define.amd ? define('d3plus-timeline', ['exports', 'd3-array', 'd3-brush', 'd3-scale', 'd3-selection', 'd3plus-axis', 'd3plus-color', 'd3plus-common', 'd3plus-format', 'd3plus-text'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}, global.d3Array, global.d3Brush, global.d3Scale, global.d3Selection, global.d3plusAxis, global.d3plusColor, global.d3plusCommon, global.d3plusFormat, global.d3plusText));
})(this, function (exports, d3Array, d3Brush, d3Scale, d3Selection, d3plusAxis, d3plusColor, d3plusCommon, d3plusFormat, d3plusText) {
  'use strict';
  ...
  var Timeline = /*#__PURE__*/function (_d3plusAxis$Axis) {
    ...
    */
    function Timeline() {
      ...
      _this._brushMin = d3plusCommon.constant(1);
    ...
    _createClass(Timeline, [{
      ...
      */
      ...
      value: function _updateDomain(event) {
        ...
        if (this._buttonBehaviorCurrent === "ticks") {
          ...
          var minDomain = d3plusAxis.date(d3plusCommon.closest(domain[0], ticks));
          var minIndex = ticks.indexOf(+minDomain);
          var maxDomain = d3plusAxis.date(d3plusCommon.closest(domain[1], ticks));
          ...
          if (ticksApart < minTicksAllowed) {
            ...
            maxIndex = d3Array.min([ticks.length - 1, maxIndex + (minTicksAllowed - ticksApart)]);
            ...
            if (ticksApart < minTicksAllowed) {
              minIndex = d3Array.max([0, minIndex - (minTicksAllowed - ticksApart)]);
      ...
      */
      ...
      value: function render(callback) {
        ...
        var tickFormat = this._tickFormat = this._tickFormat ? this._tickFormat : function (d) {
          return d3plusFormat.formatDate(d, ticks);
        };
        ...
        if (this._ticks) this._ticks = this._ticks.map(d3plusAxis.date);
        if (this._buttonBehaviorCurrent === "buttons") {
          this._scale = "ordinal";
          this._labelRotation = 0;
          if (!this._brushing) this._handleSize = 0;
          var domain = d3Scale.scaleTime().domain(this._domain.map(d3plusAxis.date)).ticks().map(Number);
          ...
          this._labels = d3Array.extent(ticks);
        }
        ...
        var defaultSelection = [this._brushMin() > defaultData.length ? defaultData[0] : defaultData[defaultData.length - this._brushMin()], defaultData[defaultData.length - 1]];

        // the current selection, considering user input, defaults, and data
        var selection = this._selection === void 0 ? defaultSelection : this._selection instanceof Array ? this._buttonBehaviorCurrent === "buttons" ? this._selection.map(function (d) {
      ...
      */
      ...
      value: function brushMin(_) {
        return arguments.length ? (this._brushMin = typeof _ === "function" ? _ : d3plusCommon.constant(_), this) : this._brushMin;
      }
