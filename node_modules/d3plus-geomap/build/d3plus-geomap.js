    ...
    _createClass(Geomap, [{
      ...
      */
      ...
      value: function _draw(callback) {
        ...
        for (var _e2 = 0; _e2 < shapeEvents.length; _e2++) circles.on(shapeEvents[_e2], this._on[shapeEvents[_e2]]);
        for (var _e3 = 0; _e3 < classEvents.length; _e3++) circles.on(classEvents[_e3], this._on[classEvents[_e3]]);
