...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-array'), require('d3-interpolate'), require('d3-scale'), require('d3-selection'), require('d3-transition'), require('d3plus-axis'), require('d3plus-color'), require('d3plus-common'), require('d3plus-format'), require('d3plus-shape'), require('d3plus-text')) : typeof define === 'function' && define.amd ? define('d3plus-legend', ['exports', 'd3-array', 'd3-interpolate', 'd3-scale', 'd3-selection', 'd3-transition', 'd3plus-axis', 'd3plus-color', 'd3plus-common', 'd3plus-format', 'd3plus-shape', 'd3plus-text'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}, global.d3Array, global.d3Interpolate, global.d3Scale, global.d3Selection, global.d3Transition, global.d3plusAxis, global.d3plusColor, global.d3plusCommon, global.d3plusFormat, global.shapes, global.d3plusText));
})(this, function (exports, d3Array, d3Interpolate, d3Scale, d3Selection, d3Transition, d3plusAxis, d3plusColor, d3plusCommon, d3plusFormat, shapes, d3plusText) {
  'use strict';
    ...
    _createClass(Legend, [{
      ...
      value: function render(callback) {
        ...
        this._lineData = this._data.map(function (d, i) {
          ...
          var h = availableHeight - (_this3._data.length + 1) * _this3._padding,
            w = _this3._width;
          var newRes = d3plusText.textWrap().fontFamily(f).fontSize(s).lineHeight(lh).width(w).height(h)(label);
      ...
      */
      ...
      value: function select(_) {
        if (arguments.length) {
          this._select = d3Selection.select(_);
          this._rtl = d3plusText.rtl(this._select.node());
          return this;
        }
        return this._select;
      }
    ...
    */
    _createClass(ColorScale, [{
      ...
      value: function render(callback) {
        ...
        var numBuckets = d3Array.min([this._buckets instanceof Array ? this._buckets.length : this._buckets, diverging && this._scale !== "jenks" ? 2 * Math.floor(d3plusCommon.unique(allValues).length / 2) - 1 : d3plusCommon.unique(allValues).length]);
        var colors = diverging ? undefined : this._color,
          labels,
          ticks;
        ...
        if (this._scale === "jenks") {
          ...
          if (this._buckets instanceof Array) {
            ...
            if (diverging && this._centered) {
              ...
              var negativeJenks = ckmeans(negatives, d3Array.min([half + residual * isNegativeMax, negatives.length]));
              var positiveJenks = ckmeans(positives, d3Array.min([half + residual * isPositiveMax, positives.length]));
          ...
          if (diverging && !colors) {
            ...
            var negativeColorScale = d3Interpolate.interpolateRgb.gamma(2.2)(this._colorMin, this._colorMid);
            ...
            var positiveColorScale = d3Interpolate.interpolateRgb.gamma(2.2)(this._colorMax, this._colorMid);
