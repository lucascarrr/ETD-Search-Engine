...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('html-to-image'), require('file-saver')) : typeof define === 'function' && define.amd ? define('d3plus-export', ['exports', 'html-to-image', 'file-saver'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}, global.htmlToImage, global.fileSaver));
})(this, function (exports, htmlToImage, fileSaver) {
  'use strict';
  ...
  */
  function saveElement(elem) {
    ...
    function finish(blob) {
      fileSaver.saveAs(blob, "".concat(options.filename, ".").concat(options.type));
      if (options.callback) options.callback();
    }
    if (options.type === "svg") {
      htmlToImage.toSvg(elem, renderOptions).then(function (dataUrl) {
