...
(function (global, factory) {
  ...
  */
  function date(d) {
    ...
    if (strFormat) {
      ...
      if (_year.indexOf("-") === 0) s = s.replace(_year, _year.substring(1));
    ...
    if (quarterPrefix || quarterSuffix) {
      ...
      var _year2 = +(quarterPrefix ? quarterPrefix[2] : quarterSuffix[1]);
      var _date3 = new Date(_year2, quarter * 3 - 3, 1);
      _date3.setFullYear(_year2);
      return _date3;
    }

    // detects if only passing a year value
    if (!s.includes("/") && !s.includes(" ") && (!s.includes("-") || !s.indexOf("-"))) {
      var _date4 = new Date(+s, 0, 1);
      _date4.setFullYear(d);
      return _date4;
    }
  ...
  */
  ...
  function calculateTicks(scale) {
    ...
    var tickScale = scales__namespace.scaleSqrt().domain([10, 400]).range([10, 50]);
    ...
    var domain = this._data.length ? d3Array.extent(this._data) : scale.domain();
    var diff = ticks[1] - ticks[0];
    if (!ticks.find(function (d) {
      return +d === +domain[0];
    })) {
      ...
      _this._shapeConfig = {
        ...
        labelConfig: {
          ...
          textAnchor: function textAnchor() {
            var rtl = d3plusText.rtl(_this._select.node());
    ...
    _createClass(Axis, [{
      ...
      */
      ...
      value: function _getPosition(d) {
        return this._scale === "log" && d === 0 ? (this._d3Scale || this._d3ScaleNegative).range()[this._d3Scale ? 0 : 1] : (this._scale === "log" && d < 0 ? this._d3ScaleNegative || function () {
          return 0;
        } : this._d3Scale)(d);
      }
      ...
      value: function render(callback) {
        ...
        var tickFormat = this._tickFormat ? this._tickFormat : function (d) {
          if (isNaN(d) || ["band", "ordinal", "point"].includes(_this2._scale)) {
            ...
            return d3plusFormat.formatDate(d, (_this2._data || labels).map(date)).replace(/^Q/g, timeLocale.quarter);
        ...
        function setScale() {
          ...
          if (this._scale === "log") {
            ...
            if (_domain[0] < 0 && _domain[_domain.length - 1] < 0) {
              ...
              var percentScale = scales__namespace.scaleLinear().domain(_domain).range([0, 1]);
        ...
        function calculateLabelSize(datum) {
          ...
          var wrap = d3plusText.textWrap().fontFamily(fF).fontSize(fS).lineHeight(this._shapeConfig.lineHeight ? this._shapeConfig.lineHeight(d, i) : undefined);
  ...
  */
  var AxisBottom = /*#__PURE__*/function (_Axis) {
    ...
    */
    ...
    return _createClass(AxisBottom);
  }(Axis);
  /**
      @class AxisLeft
      @extends Axis
