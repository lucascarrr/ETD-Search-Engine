...
function _toPropertyKey(arg) { var key = _toPrimitive2(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
...
(function (factory) {
  ...
  if (!$Number(' 0o1') || !$Number('0b1') || $Number('+0x1')) {
    $Number = function Number(value) {
      ...
      }) : _cof(that) != NUMBER$1) ? _inheritIfRequired(new Base$1(toNumber(it)), that, $Number) : toNumber(it);
    };
  ...
  _export(_export.S + _export.F * _fails(function () {
    ...
    sinh: function sinh(x) {
      return Math.abs(x = +x) < 1 ? (_mathExpm1(x) - _mathExpm1(-x)) / 2 : (exp$2(x - 1) - exp$2(-x - 1)) * (Math.E / 2);
    }
  });
  ...
  var toMetaKey$9 = function toMetaKey$9(it) {
  ...
  _metadata.exp({
    getOwnMetadata: function getOwnMetadata(metadataKey, target /* , targetKey */) {
      return ordinaryGetOwnMetadata(metadataKey, _anObject(target), arguments.length < 3 ? undefined : toMetaKey$4(arguments[2]));
    }
  });
  ...
  _metadata.exp({
    hasOwnMetadata: function hasOwnMetadata(metadataKey, target /* , targetKey */) {
      return ordinaryHasOwnMetadata(metadataKey, _anObject(target), arguments.length < 3 ? undefined : toMetaKey$1(arguments[2]));
    }
  });
  ...
  _metadata.exp({
    metadata: function metadata(metadataKey, metadataValue) {
      return function decorator(target, targetKey) {
        ordinaryDefineOwnMetadata(metadataKey, metadataValue, (targetKey !== undefined ? _anObject : _aFunction)(target), toMetaKey(targetKey));
      };
    }
  });
  ...
  */
  function drawTimeline() {
    ...
    if (timelinePossible) {
      ...
      var dataExtent = d3Array.extent(data.map(this._time).map(d3plusAxis.date));
    ...
    if (d && this._tooltip(d, i)) {
      ...
      var hasUserClick = Object.keys(this._on).some(function (e) {
        return (
          ...
          _this9._on[e].toString() !== defaultClick
        );
      });
    ...
    if (d && this._tooltip(d, i)) {
      ...
      var hasUserClick = Object.keys(this._on).some(function (e) {
        return (
          ...
          _this10._on[e].toString() !== defaultClick
        );
      });
      ...
      this._select.style("cursor", hasUserClick || hasDefaultClick && hasDeeperLevel ? "pointer" : "auto");
      var position = event.touches ? [event.touches[0].clientX, event.touches[0].clientY] : [event.clientX, event.clientY];
      this._tooltipClass.data([x || d]).footer(hasDefaultClick && hasDeeperLevel ? this._translate("Click to Expand") : false).title(this._drawLabel).position(position).config(d3plusCommon.configPrep.bind(this)(this._tooltipConfig)).render();
    }
  }
  ...
  */
  function zoomControls() {
    ...
    this._zoomBehavior.extent([[0, 0], [width, height]]).scaleExtent([1, this._zoomMax]).translateExtent([[0, 0], [width, height]]).on("zoom", function (event) {
      return zoomed.bind(_this11)(event.transform);
    });
  ...
  var Viz = /*#__PURE__*/function (_d3plusCommon$BaseCla) {
    ...
    */
    function Viz() {
      ...
      _this12._aggs = {};
      _this12._ariaHidden = true;
      _this12._attribution = false;
      _this12._attributionStyle = {
      ...
      _this12._backClass = new d3plusText.TextBox().on("click", function () {
        if (_this12._history.length) _this12.config(_this12._history.pop()).render();else _this12.depth(_this12._drawDepth - 1).filter(false).render();
      }).on("mousemove", function () {
        return _this12._backClass.select().style("cursor", "pointer");
      });
      _this12._backConfig = {
        fontSize: 10,
        padding: 5,
      ...
      _this12._cache = true;
      _this12._color = function (d, i) {
        return _this12._groupBy[0](d, i);
      };
      _this12._colorScaleClass = new d3plusLegend.ColorScale();
      _this12._colorScaleConfig = {
        scale: "jenks"
      };
      _this12._colorScalePadding = defaultPadding;
      _this12._colorScalePosition = function () {
        return _this12._width > _this12._height ? "right" : "bottom";
      };
      _this12._colorScaleMaxSize = 600;
      _this12._data = [];
      _this12._dataCutoff = 100;
      _this12._detectResize = true;
      _this12._detectResizeDelay = 400;
      _this12._detectVisible = true;
      _this12._detectVisibleInterval = 1000;
      _this12._downloadButton = false;
      _this12._downloadConfig = {
        type: "png"
      };
      _this12._downloadPosition = "top";
      _this12._duration = 600;
      _this12._hidden = [];
      _this12._hiddenColor = d3plusCommon.constant("#aaa");
      _this12._hiddenOpacity = d3plusCommon.constant(0.5);
      _this12._history = [];
      _this12._groupBy = [d3plusCommon.accessor("id")];
      _this12._legend = function (config, arr) {
        var maxGrouped = d3Array.max(arr, function (d, i) {
          var id = _this12._groupBy[_this12._legendDepth].bind(_assertThisInitialized(_this12))(d, i);
          return id instanceof Array ? id.length : 1;
        });
        return arr.length > 1 && maxGrouped <= 2;
      };
      _this12._legendClass = new d3plusLegend.Legend();
      _this12._legendConfig = {
        label: legendLabel.bind(_assertThisInitialized(_this12)),
        shapeConfig: {
          ariaLabel: legendLabel.bind(_assertThisInitialized(_this12)),
          labelConfig: {
            fontColor: undefined,
            fontResize: false,
            padding: 0
      ...
      _this12._legendFilterInvert = d3plusCommon.constant(false);
      _this12._legendPadding = defaultPadding;
      _this12._legendPosition = function () {
        return _this12._width > _this12._height ? "right" : "bottom";
      };
      _this12._legendSort = function (a, b) {
        return _this12._drawLabel(a).localeCompare(_this12._drawLabel(b));
      };
      _this12._legendTooltip = {};
      _this12._loadingHTML = function () {
        return "\n    <div style=\"left: 50%; top: 50%; position: absolute; transform: translate(-50%, -50%); font-family: 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif;\">\n      <strong>".concat(_this12._translate("Loading Visualization"), "</strong>\n      <sub style=\"bottom: 0; display: block; line-height: 1; margin-top: 5px;\"><a href=\"https://d3plus.org\" target=\"_blank\">").concat(_this12._translate("Powered by D3plus"), "</a></sub>\n    </div>");
      };
      _this12._loadingMessage = true;
      _this12._lrucache = lrucache__default["default"](10);
      _this12._messageClass = new Message();
      _this12._messageMask = "rgba(0, 0, 0, 0.05)";
      _this12._messageStyle = {
        "bottom": "0",
        "left": "0",
        "position": "absolute",
        "right": "0",
      ...
      _this12._noDataHTML = function () {
        return "\n    <div style=\"left: 50%; top: 50%; position: absolute; transform: translate(-50%, -50%); font-family: 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif;\">\n      <strong>".concat(_this12._translate("No Data Available"), "</strong>\n    </div>");
      };
      _this12._noDataMessage = true;
      _this12._on = {
        "click.shape": clickShape.bind(_assertThisInitialized(_this12)),
        "click.legend": clickLegend.bind(_assertThisInitialized(_this12)),
        "mouseenter": mouseenter.bind(_assertThisInitialized(_this12)),
        "mouseleave": mouseleave.bind(_assertThisInitialized(_this12)),
        "mousemove.shape": mousemoveShape.bind(_assertThisInitialized(_this12)),
        "mousemove.legend": mousemoveLegend.bind(_assertThisInitialized(_this12))
      };
      _this12._queue = [];
      _this12._resizeContainer = typeof window === "undefined" ? "" : window;
      _this12._scrollContainer = typeof window === "undefined" ? "" : window;
      _this12._shape = d3plusCommon.constant("Rect");
      _this12._shapes = [];
      _this12._shapeConfig = {
        ariaLabel: function ariaLabel(d, i) {
          return _this12._drawLabel(d, i);
        },
        fill: function fill(d, i) {
          while (d.__d3plus__ && d.data) {
            d = d.data;
          ...
          if (_this12._colorScale) {
            var _c = _this12._colorScale(d, i);
            if (_c !== undefined && _c !== null) {
              var scale = _this12._colorScaleClass._colorScale;
              var colors = _this12._colorScaleClass.color();
          ...
          var c = _this12._color(d, i);
          if (d3Color.color(c)) return c;
          return d3plusColor.colorAssign(c);
        },
        labelConfig: {
          fontColor: function fontColor(d, i) {
            var c = typeof _this12._shapeConfig.fill === "function" ? _this12._shapeConfig.fill(d, i) : _this12._shapeConfig.fill;
        ...
        stroke: function stroke(d, i) {
          var c = typeof _this12._shapeConfig.fill === "function" ? _this12._shapeConfig.fill(d, i) : _this12._shapeConfig.fill;
          return d3Color.color(c).darker(0.25);
        },
        role: "presentation",
      ...
      _this12._svgDesc = "";
      _this12._svgTitle = "";
      _this12._timeline = true;
      _this12._timelineClass = new d3plusTimeline.Timeline().align("end");
      _this12._timelineConfig = {
        brushing: false,
        padding: 5
      };
      _this12._timelinePadding = defaultPadding;
      _this12._threshold = d3plusCommon.constant(0.0001);
      _this12._thresholdKey = undefined;
      _this12._thresholdName = function () {
        return _this12._translate("Values");
      };
      _this12._titleClass = new d3plusText.TextBox();
      _this12._titleConfig = {
        ariaHidden: true,
        fontSize: 12,
        padding: 5,
        resize: false,
      ...
      _this12._titlePadding = defaultPadding;
      _this12._tooltip = d3plusCommon.constant(true);
      _this12._tooltipClass = new d3plusTooltip.Tooltip();
      _this12._tooltipConfig = {
        pointerEvents: "none",
        titleStyle: {
          "max-width": "200px"
        }
      };
      _this12._totalClass = new d3plusText.TextBox();
      _this12._totalConfig = {
        fontSize: 10,
        padding: 5,
        resize: false,
        textAnchor: "middle"
      };
      _this12._totalFormat = function (d) {
        return "".concat(_this12._translate("Total"), ": ").concat(d3plusFormat.formatAbbreviate(d, _this12._locale));
      };
      _this12._totalPadding = defaultPadding;
      _this12._zoom = false;
      _this12._zoomBehavior = d3Zoom.zoom();
      _this12._zoomBrush = d3Brush.brush();
      _this12._zoomBrushHandleSize = 1;
      _this12._zoomBrushHandleStyle = {
        fill: "#444"
      };
      _this12._zoomBrushSelectionStyle = {
        "fill": "#777",
        "stroke-width": 0
      };
      _this12._zoomControlStyle = {
        "background": "rgba(255, 255, 255, 0.75)",
      ...
      _this12._zoomControlStyleActive = {
        background: "rgba(0, 0, 0, 0.75)",
        color: "rgba(255, 255, 255, 0.75)",
        opacity: 1
      };
      _this12._zoomControlStyleHover = {
        cursor: "pointer",
        opacity: 1
      };
      _this12._zoomFactor = 2;
      _this12._zoomMax = 16;
      _this12._zoomPadding = 20;
      _this12._zoomPan = true;
      _this12._zoomScroll = true;
      return _this12;
    }
    ...
    _createClass(Viz, [{
      ...
      value: function _preDraw() {
        ...
        this._id = function (d, i) {
          var groupByDrawDepth = accessorFetch(_this13._groupBy[_this13._drawDepth], d, i);
        ...
        this._ids = function (d, i) {
          return _this13._groupBy.map(function (g) {
            return "".concat(accessorFetch(g, d, i));
          }).filter(Boolean);
        };
        this._drawLabel = function (d, i) {
          var depth = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _this13._drawDepth;
          if (!d) return "";
          while (d.__d3plus__ && d.data) {
            d = d.data;
            i = d.i;
          ...
          if (d._isAggregation) {
            return "".concat(_this13._thresholdName(d, i), " < ").concat(d3plusFormat.formatAbbreviate(d._threshold * 100, _this13._locale), "%");
          }
          if (_this13._label && depth === _this13._drawDepth) return "".concat(_this13._label(d, i));
        ...
        if (this._time && !this._timeFilter && this._data.length) {
          ...
          if (this._discrete && "_".concat(this._discrete) in this && this["_".concat(this._discrete)](d, i) === this._time(d, i)) {
            ...
            this._timeFilter = function (d, i) {
              return +d3plusAxis.date(_this13._time(d, i)) === latestTime;
            };
          }
        }
        this._filteredData = [];
        ...
        if (this._data.length) {
          ...
          var nestKeys = [];
          for (var _i2 = 0; _i2 <= this._drawDepth; _i2++) nestKeys.push(this._groupBy[_i2]);
          ...
          var tree = d3Array.rollup.apply(d3Array, [flatData, function (leaves) {
            var index = _this13._data.indexOf(leaves[0]);
            var shape = _this13._shape(leaves[0], index);
            var id = _this13._id(leaves[0], index);
            var d = d3plusCommon.merge(leaves, _this13._aggs);
            if (!_this13._hidden.includes(id) && (!_this13._solo.length || _this13._solo.includes(id))) {
              if (!_this13._discrete && shape === "Line") _this13._filteredData = _this13._filteredData.concat(leaves);else _this13._filteredData.push(d);
            }
            _this13._legendData.push(d);
          }].concat(nestKeys));
      ...
      */
      ...
      value: function render(callback) {
        ...
        d3Selection.select(this._resizeContainer).on("resize.".concat(this._uuid), null);
        if (this._detectVisible && this._select.style("visibility") === "hidden") {
          this._visiblePoll = setInterval(function () {
            if (_this14._select.style("visibility") !== "hidden") {
              _this14._visiblePoll = clearInterval(_this14._visiblePoll);
              _this14.render(callback);
            }
          }, this._detectVisibleInterval);
        } else if (this._detectVisible && this._select.style("display") === "none") {
          this._visiblePoll = setInterval(function () {
            if (_this14._select.style("display") !== "none") {
              _this14._visiblePoll = clearInterval(_this14._visiblePoll);
              _this14.render(callback);
            }
          }, this._detectVisibleInterval);
          ...
          d3Selection.select(this._scrollContainer).on("scroll.".concat(this._uuid), function () {
            if (!_this14._scrollPoll) {
              _this14._scrollPoll = setTimeout(function () {
                if (inViewport(_this14._select.node())) {
                  d3Selection.select(_this14._scrollContainer).on("scroll.".concat(_this14._uuid), null);
                  _this14.render(callback);
                }
                _this14._scrollPoll = clearTimeout(_this14._scrollPoll);
              }, _this14._detectVisibleInterval);
            }
          });
        } else {
          var q = d3Queue.queue();
          this._queue.forEach(function (p) {
            var cache = _this14._cache ? _this14._lrucache.get("".concat(p[3], "_").concat(p[1])) : undefined;
            if (!cache) q.defer.apply(q, _toConsumableArray(p));else _this14["_".concat(p[3])] = p[2] ? p[2](cache) : cache;
          });
          this._queue = [];
          ...
          q.awaitAll(function () {
            var columns = _this14._data instanceof Array && _this14._data.length > 0 ? Object.keys(_this14._data[0]) : [];
            var svgTable = _this14._select.selectAll("g.data-table").data(!_this14._ariaHidden && _this14._data instanceof Array && _this14._data.length ? [0] : []);
            var svgTableEnter = svgTable.enter().append("g").attr("class", "data-table").attr("role", "table");
            svgTable.exit().remove();
            var rows = svgTable.merge(svgTableEnter).selectAll("text").data(_this14._data instanceof Array ? d3Array.range(0, _this14._data.length + 1) : []);
            rows.exit().remove();
            var cells = rows.merge(rows.enter().append("text").attr("role", "row")).selectAll("tspan").data(function (d, i) {
              return columns.map(function (c) {
                return {
                  role: i ? "cell" : "columnheader",
                  text: i ? _this14._data[i - 1][c] : c
                };
              });
            });
            cells.exit().remove();
            ...
            _this14._preDraw();
            _this14._draw(callback);
            zoomControls.bind(_this14)();
            drawAttribution.bind(_this14)();
            if (_this14._messageClass._isVisible && (!_this14._noDataMessage || _this14._filteredData.length)) {
              _this14._messageClass.hide();
              if (_this14._select.attr("opacity") === "0") _this14._select.transition().duration(_this14._duration).attr("opacity", 1);
            }
            if (_this14._detectResize && (_this14._autoWidth || _this14._autoHeight)) {
              d3Selection.select(_this14._resizeContainer).on("resize.".concat(_this14._uuid), function () {
                _this14._resizePoll = clearTimeout(_this14._resizePoll);
                _this14._resizePoll = setTimeout(function () {
                  _this14._resizePoll = clearTimeout(_this14._resizePoll);
                  setSVGSize.bind(_this14)();
                  _this14.render(callback);
                }, _this14._detectResizeDelay);
              });
            }
            if (callback) setTimeout(callback, _this14._duration + 100);
          });
        }
      ...
      value: function groupBy(_) {
        ...
        return this._groupBy = _.map(function (k) {
          if (typeof k === "function") return k;else {
            if (!_this15._aggs[k]) {
              _this15._aggs[k] = function (a, c) {
                var v = d3plusCommon.unique(a.map(c).map(String));
        ...
        if (this._shapeConfig.hoverOpacity !== 1) {
          if (typeof _ === "function") {
            ...
            if (activeIds.length) hoverFunction = function hoverFunction(d, i) {
              return activeIds.includes(JSON.stringify(_this16._ids(d, i)));
            };
          }
          this._shapes.forEach(function (s) {
      ...
      */
      ...
      value: function legendFilterInvert(_) {
        return arguments.length ? (this._legendFilterInvert = typeof _ === "function" ? _ : d3plusCommon.constant(_), this) : this._legendFilterInvert;
      }
