...
(function (global, factory) {
  ...
  */
  ...
  var formatHour = d3TimeFormat.timeFormat("%I %p"),
    ...
    formatQuarter = d3TimeFormat.timeFormat("Q%q"),
    formatQuarterYear = d3TimeFormat.timeFormat("Q%q %Y"),
  ...
  */
  function formatDate(d, dataArray) {
    ...
    ? +d3Time.timeYear(d) === d || firstOrLast || smallArray ? formatQuarterYear : formatQuarter : monthlySteps.every(function (s) {
      return s >= 1 && !(s % 1);
    }) // Monthly Data
    ? +d3Time.timeYear(d) === d || firstOrLast || smallArray ? formatMonthYear : formatMonth : dailySteps.every(function (s) {
      return s >= 1 && !(s % 1);
    }) // Daily Data
    ? +d3Time.timeYear(d) === d || firstOrLast || smallArray ? formatMonthDayYear : formatMonthDay : hourlySteps.every(function (s) {
      return s >= 1 && !(s % 1);
    }) // Hourly Data
